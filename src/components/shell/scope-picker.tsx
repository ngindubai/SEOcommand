...
export function ScopePicker({ label = "Website or portfolio scope", onNavigate }: { label?: string; onNavigate?: () => void }) {
  ...
  }} className="h-10 w-full min-w-0 rounded-md border border-border bg-card px-2 text-sm font-semibold text-ink">
