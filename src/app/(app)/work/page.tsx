...
export default function WorkPage() {
  ...
  const scopedItems = useMemo(() => items.filter((item) => scopedSiteIds(websiteScope, sites, groups).has(item.domainSlug)), [items, websiteScope, sites, groups]);
