...
5. New legacy Analytics requests now use exactly 28 closed dates rather than including today in a 29-day request. A requested 7-day view cannot silently reuse 28/29-day totals.
...
- Analytics session figures are estimates and can differ slightly when summed across days versus queried for a whole period. MortgageCompare: 487 daily-summed sessions versus 484 in the saved overview; InsureCompare: 60 versus 59. PetTransportGlobal's overview includes today's activity and therefore differs from the closed-day dashboard (156 versus 152). These were not force-adjusted to agree.
